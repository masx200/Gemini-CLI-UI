export declare const authenticatedFetch: (url: RequestInfo | URL, options?: RequestInit & {
...
export declare const api: {
    ...
    sessions: (projectName: any, limit?: number, offset?: number) => Promise<Response>;
    ...
    readFile: (projectName: any, filePath: string | number | boolean) => Promise<Response>;
    saveFile: (projectName: any, filePath: any, content: any) => Promise<Response>;
