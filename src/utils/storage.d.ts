...
export declare function createStorage<T extends object>(
  type: StorageType,
...
type LocalForage<T extends object> =
  & Omit<typeof localforage, "getItem" | "removeItem" | "setItem">
  & {
...
export declare function createLocalforage<T extends object>(
