...
export default function McpServerManagement({ mcpServers, openMcpForm }) {
    return _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Server, { className: "w-5 h-5 text-purple-500" }), _jsx("h3", { className: "text-lg font-medium text-foreground", children: "MCP Servers" })] }), _jsx("div", { className: "space-y-2", children: _jsx("p", { className: "text-sm text-muted-foreground", children: "Model Context Protocol servers provide additional tools and data sources to Claude" }) }), _jsx("div", { className: "flex justify-between items-center", children: _jsxs(Button, { onClick: () => openMcpForm(), className: "bg-purple-600 hover:bg-purple-700 text-white", size: "sm", children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Add MCP Server"] }) }), _jsxs("div", { className: "space-y-2", children: [mcpServers.map((server) => (_jsx("div", { className: "bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [getTransportIcon(server.type), _jsx("span", { className: "font-medium text-foreground", children: server.name }), _jsx(Badge, { variant: "outline", className: "text-xs", children: server.type }), _jsx(Badge, { variant: "outline", className: "text-xs", children: server.scope === "local"
                                                        ? "📁 local"
                                                        : server.scope === "user"
                                                            ? "👤 user"
                                                            : server.scope }), server.projectPath && (_jsx(Badge, { variant: "outline", className: "text-xs bg-purple-50 dark:bg-purple-900/20", title: server.projectPath, children: server.projectPath.split("/").pop() }))] }), _jsxs("div", { className: "text-sm text-muted-foreground space-y-1", children: [server.type === "stdio" && server.config.command && (_jsxs("div", { children: ["Command:", " ", _jsx("code", { className: "bg-gray-100 dark:bg-gray-800 px-1 rounded text-xs", children: server.config.command })] })), (server.type === "sse" || server.type === "http") &&
                                                    server.config.url && (_jsxs("div", { children: ["URL:", " ", _jsx("code", { className: "bg-gray-100 dark:bg-gray-800 px-1 rounded text-xs", children: server.config.url })] })), server.config.args && server.config.args.length > 0 && (_jsxs("div", { children: ["Args:", " ", _jsx("code", { className: "bg-gray-100 dark:bg-gray-800 px-1 rounded text-xs", children: server.config.args.join(" ") })] })), server.config.env &&
                                                    Object.keys(server.config.env).length > 0 && (_jsxs("div", { children: ["Environment:", " ", _jsx("code", { className: "bg-gray-100 dark:bg-gray-800 px-1 rounded text-xs", children: Object.entries(server.config.env)
                                                                .map(([k, v]) => `${k}=${v}`)
    ...
    }
    {
        showMcpForm && (_jsx("div", { className: "fixed inset-0 bg-black/50 flex items-center justify-center z-[110] p-4", children: _jsxs("div", { className: "bg-background border border-border rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto", children: [_jsxs("div", { className: "flex items-center justify-between p-4 border-b border-border", children: [_jsx("h3", { className: "text-lg font-medium text-foreground", children: editingMcpServer ? "Edit MCP Server" : "Add MCP Server" }), _jsx(Button, { variant: "ghost", size: "sm", onClick: resetMcpForm, children: _jsx(X, { className: "w-4 h-4" }) })] }), _jsxs("form", { onSubmit: handleMcpSubmit, className: "p-4 space-y-4", children: [!editingMcpServer && (_jsxs("div", { className: "flex gap-2 mb-4", children: [_jsx("button", { type: "button", onClick: () => setMcpFormData((prev) => ({ ...prev, importMode: "form" })), className: `px-4 py-2 rounded-lg font-medium transition-colors ${mcpFormData.importMode === "form"
                                            ...
                                            : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"}`, children: "Form Input" }), _jsx("button", { type: "button", onClick: () => setMcpFormData((prev) => ({ ...prev, importMode: "json" })), className: `px-4 py-2 rounded-lg font-medium transition-colors ${mcpFormData.importMode === "json"
                                            ? "bg-blue-600 text-white"
                                            : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"}`, children: "JSON Import" })] })), mcpFormData.importMode === "form" && editingMcpServer && (_jsxs("div", { className: "bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-3", children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Scope" }), _jsxs("div", { className: "flex items-center gap-2", children: [mcpFormData.scope === "user" ? (_jsx(Globe, { className: "w-4 h-4" })) : (_jsx(FolderOpen, { className: "w-4 h-4" })), _jsx("span", { className: "text-sm", children: mcpFormData.scope === "user"
                                                    ? "User (Global)"
                                                    : "Project (Local)" }), mcpFormData.scope === "local" && mcpFormData.projectPath && (_jsxs("span", { className: "text-xs text-muted-foreground", children: ["- ", mcpFormData.projectPath] }))] }), _jsx("p", { className: "text-xs text-muted-foreground mt-2", children: "Scope cannot be changed when editing an existing server" })] })), mcpFormData.importMode === "form" && !editingMcpServer && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Scope *" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { type: "button", onClick: () => setMcpFormData((prev) => ({
                                                            ...prev,
                                                            scope: "user",
                                                            projectPath: "",
                                                        })), className: `flex-1 px-4 py-2 rounded-lg font-medium transition-colors ${mcpFormData.scope === "user"
                                                            ? "bg-blue-600 text-white"
                                                            : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"}`, children: _jsxs("div", { className: "flex items-center justify-center gap-2", children: [_jsx(Globe, { className: "w-4 h-4" }), _jsx("span", { children: "User (Global)" })] }) }), _jsx("button", { type: "button", onClick: () => setMcpFormData((prev) => ({ ...prev, scope: "local" })), className: `flex-1 px-4 py-2 rounded-lg font-medium transition-colors ${mcpFormData.scope === "local"
                                                            ? "bg-blue-600 text-white"
                                                            : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"}`, children: _jsxs("div", { className: "flex items-center justify-center gap-2", children: [_jsx(FolderOpen, { className: "w-4 h-4" }), _jsx("span", { children: "Project (Local)" })] }) })] }), _jsx("p", { className: "text-xs text-muted-foreground mt-2", children: mcpFormData.scope === "user"
                                                ...
                                                }, placeholder: "my-server", required: true })] }), mcpFormData.importMode === "form" && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Transport Type *" }), _jsxs("select", { value: mcpFormData.type, onChange: (e) => {
                                                    setMcpFormData((prev) => ({
                                                        ...prev,
                                                        type: e.target.value,
                                                    }));
                                                }, className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500", children: [_jsx("option", { value: "stdio", children: "stdio" }), _jsx("option", { value: "sse", children: "SSE" }), _jsx("option", { value: "http", children: "HTTP" })] })] }))] }), editingMcpServer &&
                                mcpFormData.raw &&
                                mcpFormData.importMode === "form" && (_jsxs("div", { className: "bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4", children: [_jsxs("h4", { className: "text-sm font-medium text-foreground mb-2", children: ["Configuration Details (from", " ", editingMcpServer.scope === "global"
                                                ? "~/.claude.json"
                                                : "project config", ")"] }), _jsx("pre", { className: "text-xs bg-gray-100 dark:bg-gray-800 p-3 rounded overflow-x-auto", children: JSON.stringify(mcpFormData.raw, null, 2) })] })), mcpFormData.importMode === "json" && (_jsx("div", { className: "space-y-4", children: _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "JSON Configuration *" }), _jsx("textarea", { value: mcpFormData.jsonInput, onChange: (e) => {
                                                setMcpFormData((prev) => ({
                                                    ...prev,
                                                ...
                                                try {
                                                    if (e.target.value.trim()) {
                                                        ...
                                                        else if ((parsed.type === "http" || parsed.type === "sse") &&
                                                            !parsed.url) {
                                            ...
                                            }, className: `w-full px-3 py-2 border ${jsonValidationError
                                                ? "border-red-500"
                                                : "border-gray-300 dark:border-gray-600"} bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500 font-mono text-sm`, rows: "8", placeholder: '{\n  "type": "stdio",\n  "command": "/path/to/server",\n  "args": ["--api-key", "abc123"],\n  "env": {\n    "CACHE_DIR": "/tmp"\n  }\n}', required: true }), jsonValidationError && (_jsx("p", { className: "text-xs text-red-500 mt-1", children: jsonValidationError })), _jsxs("p", { className: "text-xs text-muted-foreground mt-2", children: ["Paste your MCP server configuration in JSON format. Example formats:", _jsx("br", {}), "\u2022 stdio:", " ", `{"type":"stdio","command":"npx","args":["@upstash/context7-mcp"]}`, _jsx("br", {}), "\u2022 http/sse:", " ", `{"type":"http","url":"https://api.example.com/mcp"}`] })] }) })), mcpFormData.importMode === "form" &&
                                mcpFormData.type === "stdio" && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Command *" }), _jsx(Input, { value: mcpFormData.config.command, onChange: (e) => updateMcpConfig("command", e.target.value), placeholder: "/path/to/mcp-server", required: true })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Arguments (one per line)" }), _jsx("textarea", { value: Array.isArray(mcpFormData.config.args)
                                                    ? mcpFormData.config.args.join("\n")
                                                    : "", onChange: (e) => updateMcpConfig("args", e.target.value.split("\n").filter((arg) => arg.trim())), className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500", rows: "3", placeholder: "--api-key\nabc123" })] })] })), mcpFormData.importMode === "form" &&
                                (mcpFormData.type === "sse" || mcpFormData.type === "http") && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "URL *" }), _jsx(Input, { value: mcpFormData.config.url, onChange: (e) => updateMcpConfig("url", e.target.value), placeholder: "https://api.example.com/mcp", type: "url", required: true })] })), mcpFormData.importMode === "form" && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Environment Variables (KEY=value, one per line)" }), _jsx("textarea", { value: Object.entries(mcpFormData.config.env || {})
                                            .map(([k, v]) => `${k}=${v}`)
                                            .join("\n"), onChange: (e) => {
                                            const env = {};
                                        ...
                                        }, className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500", rows: "3", placeholder: "API_KEY=your-key\nDEBUG=true" })] })), mcpFormData.importMode === "form" &&
                                (mcpFormData.type === "sse" || mcpFormData.type === "http") && (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Headers (KEY=value, one per line)" }), _jsx("textarea", { value: Object.entries(mcpFormData.config.headers || {})
                                            .map(([k, v]) => `${k}=${v}`)
                                            .join("\n"), onChange: (e) => {
                                            const headers = {};
                                            e.target.value.split("\n").forEach((line) => {
                                        ...
                                        }, className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500", rows: "3", placeholder: "Authorization=Bearer token\nX-API-Key=your-key" })] })), _jsxs("div", { className: "flex justify-end gap-2 pt-4", children: [_jsx(Button, { type: "button", variant: "outline", onClick: resetMcpForm, children: "Cancel" }), _jsx(Button, { type: "submit", disabled: mcpLoading, className: "bg-purple-600 hover:bg-purple-700 disabled:opacity-50", children: mcpLoading
                                            ? "Saving..."
                                            : editingMcpServer
                                                ? "Update Server"
                                                : "Add Server" })] })] })] }) }));
