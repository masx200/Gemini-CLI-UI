                      ...
                      children: [
                        ...
                        (_jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsx("ul", {
                              className: "space-y-0.5",
                              children: mcpServerTools[server.id].resources.map(
                                (resource, i) => (_jsxs("li", {
                                  className: "flex items-start gap-1",
                                  children: [
                                    _jsx("span", {
                        ...
                        (_jsxs("div", {
                          children: [
                            ...
                            _jsx("ul", {
                              className: "space-y-0.5",
                              children: mcpServerTools[server.id].prompts.map((
                                prompt,
                                i,
                              ) => (_jsxs("li", {
                                className: "flex items-start gap-1",
            ...
            children: [
                    ...
                    children: [
                      ...
                      _jsxs("select", {
                        ...
                        className:
                          "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500",
                        children: [
                          _jsx("option", { value: "stdio", children: "stdio" }),
              ...
              mcpFormData.importMode === "form" && (_jsxs("div", {
                children: [
                  _jsx("label", {
                    className: "block text-sm font-medium text-foreground mb-2",
                    children: "Environment Variables (KEY=value, one per line)",
                  }),
                  _jsx("textarea", {
