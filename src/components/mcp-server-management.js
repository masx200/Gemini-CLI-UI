...
export default function McpServerManagement({ projects = [], setSaveStatus, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Server, { className: "w-5 h-5 text-purple-500" }), _jsx("h3", { className: "text-lg font-medium text-foreground", children: "MCP Servers" })] }), _jsx("div", { className: "space-y-2", children: _jsx("p", { className: "text-sm text-muted-foreground", children: "Model Context Protocol servers provide additional tools and data sources to Claude" }) }), _jsx("div", { className: "flex justify-between items-center", children: _jsxs(Button, { onClick: () => openMcpForm(), className: "bg-purple-600 hover:bg-purple-700 text-white", size: "sm", children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Add MCP Server"] }) }), _jsxs("div", { className: "space-y-2", children: [mcpServers.map((server) => (_jsx("div", { className: "bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [getTransportIcon(server.type), _jsx("span", { className: "font-medium text-foreground", children: server.name }), _jsx(Badge, { variant: "outline", className: "text-xs", children: server.type }), _jsx(Badge, { variant: "outline", className: "text-xs", children: server.scope === "local"
                                                ...
                                                : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"}`, children: "Form Input" }), _jsx("button", { type: "button", onClick: () => setMcpFormData((prev) => ({
                                                ...prev,
                                                importMode: "json",
                                                ...
                                                : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"}`, children: "JSON Import" })] })), mcpFormData.importMode === "form" && editingMcpServer && (_jsxs("div", { className: "bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-3", children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Scope" }), _jsxs("div", { className: "flex items-center gap-2", children: [mcpFormData.scope === "user" ? (_jsx(Globe, { className: "w-4 h-4" })) : (_jsx(FolderOpen, { className: "w-4 h-4" })), _jsx("span", { className: "text-sm", children: mcpFormData.scope === "user"
                                                    ...
                                                    mcpFormData.projectPath && (_jsxs("span", { className: "text-xs text-muted-foreground", children: ["- ", mcpFormData.projectPath] }))] }), _jsx("p", { className: "text-xs text-muted-foreground mt-2", children: "Scope cannot be changed when editing an existing server" })] })), mcpFormData.importMode === "form" && !editingMcpServer && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Scope *" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { type: "button", onClick: () => setMcpFormData((prev) => ({
                                                                ...
                                                                ? "bg-blue-600 text-white"
                                                                : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"}`, children: _jsxs("div", { className: "flex items-center justify-center gap-2", children: [_jsx(Globe, { className: "w-4 h-4" }), _jsx("span", { children: "User (Global)" })] }) }), _jsx("button", { type: "button", onClick: () => setMcpFormData((prev) => ({
                                                                ...prev,
                                                                scope: "local",
                                    ...
                                    mcpFormData.type === "stdio" && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Command *" }), _jsx(Input, { value: mcpFormData.config.command, onChange: (e) => updateMcpConfig("command", e.target.value), placeholder: "/path/to/mcp-server", required: true })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-foreground mb-2", children: "Arguments (one per line)" }), _jsx("textarea", { value: Array.isArray(mcpFormData.config.args)
                                                        ...
                                                        : "", onChange: (e) => updateMcpConfig("args", e.target.value
                                                        .split("\n")
