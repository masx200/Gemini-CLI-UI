...
function Sidebar({
  ...
  useEffect(() => {
    if (projects.length > 0 && !isLoading) {
      const newLoaded = new Set() as Set<string>;
  ...
  const toggleStarProject = (projectName: string) => {
  ...
  const isProjectStarred = (projectName: any) => {
  ...
  const getProjectLastActivity = (project: any) => {
        ...
        <div className="md:p-3 md:border-b md:border-border md:bg-muted/30">
          ...
          <div className="hidden md:block space-y-2">
            ...
            <Input
              ...
              onChange={(e: any) => setNewProjectPath(e.target.value)}
        ...
        <div className="md:space-y-1 pb-safe-area-inset-bottom">
          {isLoading ? (
            <div className="text-center py-12 md:py-8 px-4">
              ...
              <p className="text-sm text-muted-foreground">
                Fetching your qwen projects and sessions
              </p>
            </div>
          ) : projects.length === 0 ? (
            <div className="text-center py-12 md:py-8 px-4">
              ...
              <p className="text-sm text-muted-foreground">
                Run qwen CLI in a project directory to get started
              </p>
            </div>
                            ...
                            <div key={session.id} className="group relative">
                              ...
                              <div className="md:hidden">
                                <div
                                  ...
                                  onClick={() => {
                                    onProjectSelect(project);
                                    onSessionSelect(project, session);
                                  }}
                                  onTouchEnd={handleTouchClick(() => {
                                    onProjectSelect(project);
                                    onSessionSelect(project, session);
