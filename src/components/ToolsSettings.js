          ...
          children: [
            ...
            _jsxs("div", {
              ...
              children: [
                          ...
                          children: _jsxs("div", {
                            ...
                            children: [
                              ...
                              _jsx("div", {
                                ...
                                children: availableModels.find((m) =>
                ...
                activeTab === "appearance" && (_jsx("div", {
                  className: "space-y-6 md:space-y-8",
                  children: activeTab === "appearance" && (_jsxs("div", {
                    className: "space-y-6 md:space-y-8",
                    children: [
                      _jsx("div", {
                        className: "space-y-4",
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsxs("div", {
                          className: "space-y-2",
                          children: [
                            allowedTools.map((tool) => (_jsxs("div", {
                              className:
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsxs("div", {
                          className: "space-y-2",
                          children: [
                            disallowedTools.map((tool) => (_jsxs("div", {
                              className:
