    ...
    children: [
      ...
      _jsxs(DialogContent, {
        ...
        children: [
                ...
                children: _jsxs(Card, {
                  ...
                  children: [
                    _jsx(CardHeader, {
                      ...
                      subheader: PROVIDER_TYPES.find((t) =>
                        t.value === provider.provider_type
                        ...
                        _jsxs(Box, {
                          ...
                          children: [
                            _jsx(Button, {
                              ...
                              startIcon: _jsx(Edit, { className: "w-4 h-4" }),
                              sx: { flex: 1 },
                              children: "Edit",
                            }),
                            _jsx(Button, {
                              ...
                              startIcon: _jsx(Trash2, { className: "w-4 h-4" }),
                              sx: { flex: 1 },
                              children: "Delete",
                            }),
                          ],
          ...
          !isLoading && providers.length === 0 && !showForm && (_jsxs(Box, {
