...
- **`includeTools`** (string[]): List of tool names to include from this MCP
  ...
  server (whitelist behavior). If not specified, all tools from the server are
  enabled by default.
    ...
    messages: [
      {
        ...
        content: {
          type: "text",
          text: `Write a haiku${
            mood ? ` with the mood ${mood}` : ""
          } called ${title}. Note that a haiku is 5 syllables followed by 7 syllables followed by 5 syllables `,
        },
      },
    ],
  })
